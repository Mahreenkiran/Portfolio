...
```mermaid
flowchart LR
    A[Clinical or population question] --> B[Data governance and cohort definition]
    B --> C[Data quality assessment]
    C --> D[Exploratory analysis]
    D --> E[Feature engineering]
    E --> F[Statistical and machine learning models]
    F --> G[Validation and calibration]
    G --> H[Explainability and sensitivity analysis]
    H --> I[Clinical or public health interpretation]
...
<img src="assets/diabetes_survival.png" alt="Diabetes survival analysis" width="100%">
...
<img src="assets/dengue_auc.png" alt="Dengue model AUC comparison" width="100%">
...
<img src="assets/xai_workflow.png" alt="Explainable AI workflow" width="100%">
